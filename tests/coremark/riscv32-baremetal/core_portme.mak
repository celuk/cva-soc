...
RISCVTYPE ?= /home/shc/projects/riscvim/_install/bin/riscv32-unknown-elf
...
PORT_CFLAGS = -O2 -DTOTAL_DATA_SIZE=1200 -mcmodel=medany -static -std=gnu99 -fno-common -nostdlib -nostartfiles -fno-builtin -ffunction-sections -lm -lgcc -T $(PORT_DIR)/linkwithdram.ld
# -funroll-all-loops
# -fno-unroll-loops
