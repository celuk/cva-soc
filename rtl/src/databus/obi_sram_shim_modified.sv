...
module obi_sram_shim_modified #(
    ...
    // Check the specific definition generated by OBI_TYPEDEF macros used in secure_soc.sv.
    ...
    // For this specific case based on the secure_soc code:
    ...
    assign obi_rsp_o.r.r_optional.ruser = '0; // Width is 1 based on secure_soc config
